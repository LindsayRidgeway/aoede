...
export const IosLanguagePicker = ({
  ...
  if (__DEV__) console.log("MODULE 0014: IosPicker.keyboardDidShow");
      setKeyboardVisible(true);
    });
    
    const keyboardDidHideListener = Keyboard.addListener('keyboardDidHide', () => {
  if (__DEV__) console.log("MODULE 0015: IosPicker.keyboardDidHide");
      setKeyboardVisible(false);
    });

    return () => {
      keyboardDidShowListener.remove();
  if (__DEV__) console.log("MODULE 0016: IosPicker.keyboardDidShow");
      keyboardDidHideListener.remove();
  if (__DEV__) console.log("MODULE 0017: IosPicker.keyboardDidHide");
    };
  }, []);
...
export const IosBookPicker = ({
  ...
  useEffect(() => {
    const keyboardDidShowListener = Keyboard.addListener('keyboardDidShow', () => {
  if (__DEV__) console.log("MODULE 0018: IosPicker.keyboardDidShow");
      setKeyboardVisible(true);
    });
    
    const keyboardDidHideListener = Keyboard.addListener('keyboardDidHide', () => {
  if (__DEV__) console.log("MODULE 0019: IosPicker.keyboardDidHide");
      setKeyboardVisible(false);
    });

    return () => {
      keyboardDidShowListener.remove();
  if (__DEV__) console.log("MODULE 0020: IosPicker.keyboardDidShow");
      keyboardDidHideListener.remove();
  if (__DEV__) console.log("MODULE 0021: IosPicker.keyboardDidHide");
    };
  }, []);
