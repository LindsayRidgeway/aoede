...
// Local styles for debug messages
...
export function LibraryUI({
  ...
  // MODIFIED: Handle closing the library modal with a simpler approach
  const handleClose = () => {
    ...
    if (onClose) {
      debugLog(`LibraryUI: Explicitly calling onClose(${wasChanged})`);
      onClose(wasChanged);
    }
  };
