...
export function MainUI({
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (result.data && result.data.languages) {
            ...
            if (__DEV__) console.log("MODULE 0023: MainUI.languagesLoaded");
  ...
  useEffect(() => {
    ...
    if (__DEV__) console.log("MODULE 0024: MainUI.updateShowContent");
  }, [sentence]);
  ...
  const handleNextButtonPress = () => {
    if (__DEV__) console.log("MODULE 0025: MainUI.handleNextButtonPress");
    animateNextButton();
    nextSentence();
  };
  ...
  const handleRewindPress = () => {
    if (__DEV__) console.log("MODULE 0026: MainUI.handleRewindPress");
    if (loadingBook) {
      return;
    }
